...
number of different parties on the associated dates. President variable
indicates whether the president was democratic or republican. The year
range in pols\_df ranges from 1947 to 2015. The year range is the
largest among all three data, so when merging the datasets, 1947 - 1948
have some NA values.
...
month. The final\_df contains822 rows and 11 columns. The year ranges
from 1947 to 2015.
