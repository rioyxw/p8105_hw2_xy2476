...
entry and vending variables from character variable to logical variable.
...
```
    ...
    ##  $ unemploy_percent: num [1:816] 3.4 3.8 4 3.9 3.5 3.6 3.6 3.9 3.8 3.7 ...
...
snp\_df, and unemploy\_df. The file “pols-month” contains 822
...
Important variables in the dataset include year, month, president, The
year range in pols\_df ranges from 1947 to 2015. the number of
...
republican representatives on the associated date prez\_dem: indicator
of whether the president was democratic on the associated date (1 = yes,
0 = no) gov\_dem: the number of democratic governors on the associated
date sen\_dem: the number of democratic senators on the associated date
