...
```
##### There are `r count(filter(nycsubway_df_clean_distinct, ada == "TRUE"))` distinct stations in the distinct station dataframe. There are `r count(filter(nycsubway_df_clean, ada == "TRUE"))` distinct stations in the origianl dataframe.
